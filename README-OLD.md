...
Note: These are the old steps on how to setup a cross compilation environment. A lot of these steps have been
automated away with the plotfi/llvm-pi docker image.
