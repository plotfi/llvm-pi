...
RUN apt-get update \
    ...
    && apt install -y --no-install-recommends \
               cmake ninja-build clang clang-format lldb lld gcc g++ vim cargo htop tmux git curl \
               python3-distutils expect net-tools di tig wget netcat rsync ca-certificates neovim \
